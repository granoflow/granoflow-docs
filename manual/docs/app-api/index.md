...
![App 接口 界面截图](../../screenshots/zh-cn/app-api-local-interface-service.png)
...
连接日志面向排障，而不是日常使用。你可以按访问 IP、读写类型、端点或“仅失败”过滤；单条记录会显示方法、端点、时间、来源 IP、读写类型、耗时和状态码。需要排查 CLI 或浏览器调试时，先看这里是否真的收到了请求。
