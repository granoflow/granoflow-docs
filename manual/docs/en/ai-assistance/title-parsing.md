...
description: "When you type a task title, AI can recognize dates, tags, projects, and reminders, then show them as suggestions; nothing is applied until you confirm."
---

If you want to turn a title like “Meeting with Sarah tomorrow 3pm #work” into organized task details faster, type the full sentence into the title field; GranoFlow will try to recognize the time, tag, project, and reminder information, then show suggestions that only apply after you confirm them.
...
- **Project mentions**: text that matches the names of projects you already have
