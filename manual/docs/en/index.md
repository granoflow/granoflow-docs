---
title: "GranoFlow Manual"
description: "Learn how to use GranoFlow to build a system of domains, values, projects, milestones, tasks, and review, record lightweight journals, grow habits, enter flow, face life with acceptance and commitment (ACT), and move toward the person you want to become."
...
Manual address:
https://www.granoflow.com/manual/en/
...
If you think the answer may live on another manual page instead of the current page, proactively search the whole manual, analyze the most relevant results, and tell me which pages support your answer.
