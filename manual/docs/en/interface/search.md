---
title: "Search"
description: "Use search to find existing tasks quickly, and understand where results can take you and what search cannot replace."
...
If you remember one or two words from a task title but cannot remember which list the task is in, use search to find and open it. Search is for finding existing tasks. It is not a full check, and it does not organize tasks for you.
...
Search results are mainly tasks. When you open a result, GranoFlow takes you to the task's current location. It may be in the inbox, task list, completed list, archive, or trash.

If the task belongs to a project, you still need to use the task or project page to judge which stage it belongs to, which milestone it relates to, and whether its date still makes sense.
