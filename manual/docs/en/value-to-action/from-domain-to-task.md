...
- [先确定长期方向](/en/value-to-action/long-term-direction/)：理解领域和价值观为什么不是口号。
- [项目与里程碑：把长期方向拆成阶段目标](/en/value-to-action/projects-and-milestones/)：学会给持续投入建立骨架。
- [任务与收集箱：把下一步写下来](/en/value-to-action/tasks-and-inbox/)：把模糊的压力变成可执行动作。
