...
The page shows a few common domains first as starting points. They are suggestions: you can rename them, add values under them, or use the “New domain” button below the defaults. Domains you create yourself appear below that button.
