...
If a card or note already has a translation, card details place it in the advanced section. During review, use the translation toggle beside the front or back when it appears to show or hide the matching translation below the main text. Read the question first, reveal the answer, then rate yourself with Forgot, Hard, Good, or Easy. After revealing the answer, move the card to the recycle bin if it is no longer worth studying, or archive it if you only want to pause active review. Archived cards may still appear in related task and review contexts and are labeled archived. Both actions offer undo.
