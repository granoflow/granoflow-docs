...
任务可以放进项目里。收集箱里的任务一旦加入项目，就会自动离开收集箱。项目可以归档或完成；如果项目里还有未处理的任务，系统会先让你决定这些任务怎么处理。
...
只有没有截止日期、没有项目、没有里程碑，并且状态是待办或进行中的任务，才会出现在收集箱。一旦你给任务加了日期，或把它加入项目，它就会自动离开收集箱。你可以把收集箱想成口袋里的便条纸：先放进去，之后再整理。
...
日回顾按任务“实际完成的那一天”统计，不按截止日期统计。如果你在凌晨 3 点前完成任务，它还会算作“昨天”完成。
