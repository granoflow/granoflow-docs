...
如果你不知道某个设置会影响哪里，先看它属于哪个分组：外观、偏好设置和安全通常只影响这台设备；数据管理、关于、调研计划和 Pro 设置会带你进入对应页面，处理更具体的账号、同步、订阅、AI 或数据规则。
...
设置页是 GranoFlow 的统一入口。它把显示体验、偏好设置、安全、数据管理、隐私与诊断、关于、调研计划和 Pro 设置放在一个地方，但每个入口影响的范围不一样。
...
「调研计划」用于用户主动参与反馈或研究，不影响日常任务和数据结构。
