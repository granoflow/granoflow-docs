...
如果你想重新梳理当天任务时间，可以点“回顾今日任务”，让 AI 帮你按任务顺序检查每个任务用了多久，并整理当天涉及的领域、项目和里程碑推进。AI 只会生成建议；你把结果复制回 GranoFlow 后，还需要在确认框里确认，才会写入任务的开始时间、结束时间、标题、任务回顾或当天领域日报。完整流程见[回顾今日任务](../ai-assistance/daily-task-review)。
