...
打开 GranoFlow 的设置，进入账号/订阅页面，就可以查看当前订阅状态。未订阅且商店可用时，页面会先显示方案切换器和当前方案详情；天使会员直接购买和升级方案只会开放其中一个。可购买的天使入口会显示分钟级剩余时间，不可购买的入口只显示当前状态。商店暂不可用或正在加载时，页面只显示状态说明、已包含权益、恢复购买和管理订阅入口，不会显示价格或购买按钮。

如果当前账号已经拥有天使会员，Pro 方案会显示为已包含在天使会员中，不会再提供 Pro 购买按钮。这样可以避免已经拥有更高等级权益的用户重复购买。
...
**不同商店平台的购买能共享吗？**
不一定。当前有效商店平台的购买彼此独立；macOS DMG 版当前不作为商店购买平台。请看[平台购买与恢复购买](/subscription/platforms-and-restore/)。
