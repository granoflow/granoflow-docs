...
| 描述 | 可选 | 放背景信息、链接、备注等补充内容；支持 [Markdown 内容](/manual/interface/markdown-content/) |
...
任务描述、任务回顾，以及其他支持长文本的字段可以使用 Markdown。需要添加表格、公式、远程图片、远程音频或 YouTube 视频时，阅读 [Markdown 内容](/manual/interface/markdown-content/)。
:::caution[注意]
