...
如果你想把长期目标变成今天能做的事，先不用急着写一整套人生规划；在 GranoFlow 里，可以先用领域记录长期方向，用价值观说明自己希望怎样行动，再把它们慢慢连接到项目、里程碑、任务和回顾。

领域和价值观不是一开始必须填满的设置项。它们的作用，是让你在任务和项目之外，看见自己的时间长期流向哪里，以及这些投入是否接近你真正重视的方向。

如果你刚开始使用，可以先写任务和项目。等某些事情反复出现，再回头整理领域和价值观。
...
目标适合放进项目和里程碑。价值观适合放在领域下面，作为你长期选择的方向。

这接近 ACT（接纳与承诺疗法）里 values 的用法：价值观不是一次完成的目标，而是在不确定、困难或状态不完美时，仍然可以指向行动的方向。更多背景可以读 [ACT 与《幸福的陷阱》](/value-to-action/act-loop/)。

一个目标完成之后，可能就结束了。一个价值观会反复影响你之后的选择。
...
更好的写法，是用一句完整的话表达你希望如何行动。可以从这些句式开始：
...
一条好的价值观不一定要漂亮。它只需要在你犹豫时，能帮你判断下一步更接近哪个方向。

## 每个领域先写 1-3 条

不要一开始写人生宣言。每个领域先写 1-3 条就够。
...
这已经足够开始。价值观不是写得越多越好，而是越能影响真实行动越好。
...
即使截图没有加载，你也可以按这个思路理解页面：每个领域都有自己的价值观列表；页面会提供对应领域的问题提示，帮助你用一句完整的话写出“我希望如何行动”，而不是只写一个抽象词。达到当前可用数量上限后，需要先整理已有内容，再继续添加。
...
这更接近 GranoFlow 的使用方式：不是追求永远高效，而是在真实生活中保持方向感。
