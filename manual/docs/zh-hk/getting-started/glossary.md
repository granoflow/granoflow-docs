...
任務可以放入項目。收集箱裏的任務一旦加入項目，就會自動離開收集箱。項目可以歸檔或完成；如果項目裏仍有未處理的任務，系統會先讓你決定這些任務要怎樣處理。
...
只有沒有截止日期、沒有項目、沒有里程碑，並且狀態是待辦或進行中的任務，才會出現在收集箱。一旦你給任務加了日期，或把它加入項目，它就會自動離開收集箱。你可以把收集箱想成口袋裏的便條紙：先放入去，之後再整理。
...
日回顧按任務「實際完成的那一天」統計，不按截止日期統計。如果你在凌晨 3 點前完成任務，它仍會算作「昨天」完成。
...
AI 助手指的是你自己選擇的外部 AI 工具，例如 ChatGPT、Claude、Gemini 或 DeepSeek。
