---
title: "價值觀與提示詞"
description: "調整回顧提問、Prompt 和問卷設置，讓日回顧、周回顧和相關草稿更貼近你的語言。"
...
![價值觀與提示詞 界面截圖](../../../screenshots/manual/zh-hk/review-values-prompts-settings.png)
...
![價值觀與提示詞界面截图](../../../screenshots/manual/zh-hk/review-weekly-review-prompt-settings.png)

<!-- manual-screenshot:id=review-daily-journal-prompt-settings -->
![價值觀與提示詞界面截图](../../../screenshots/manual/zh-hk/review-daily-journal-prompt-settings.png)

<!-- manual-screenshot:id=review-domain-values-prompt-settings -->
![價值觀與提示詞界面截图](../../../screenshots/manual/zh-hk/review-domain-values-prompt-settings.png)

<!-- manual-screenshot:id=review-work-learning-report-prompt-settings -->
![價值觀與提示詞界面截图](../../../screenshots/manual/zh-hk/review-work-learning-report-prompt-settings.png)
...
![價值觀與提示詞界面截图](../../../screenshots/manual/zh-hk/review-questionnaire-prompt-settings.png)
