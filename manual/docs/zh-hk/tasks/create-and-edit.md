...
| 項目 | 可選 | 設置任務歸屬；如果仍然沒有日期，它也會繼續出現在收集箱 |
...
:::tip[善用自然語言輸入]
在快速添加任務時，你可以直接寫日期詞、`#標籤名`、`@項目或里程碑`、`~提醒時間`。比如輸入 `整理報告 明天 #工作 @論文初稿 ~下午3點`，GranoFlow 會把明天的日期、「工作」標籤、項目或里程碑候選和提醒時間顯示出來，等你確認後再寫入對應欄位。詳細規則見[用自然語言寫任務](title-parser)。
:::
