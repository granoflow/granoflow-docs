---
title: "AI 助理與剪貼簿"
description: "從剪貼簿把零散內容整理成任務前，理解預覽、確認和回寫邊界。"
...
![AI 助理與剪貼簿 介面截圖](../../../screenshots/manual/zh-tw/ai-clipboard-assistant-settings.png)

## 怎麼操作

- 先把要處理的文本放進標題或剪貼簿助手，不要一次提供無關的大段內容。
...
如果你擔心資料範圍，先讀“哪些內容可能會提供給 AI”；如果擔心誤改，讀“為什麼修改前需要確認”。
