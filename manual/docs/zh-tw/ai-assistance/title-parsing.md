---
title: "AI 如何輔助整理標題"
description: "輸入任務標題時，AI 可以識別日期、標籤、專案 / 里程碑提及和提醒，並以建議形式顯示；只有你確認後才會寫入任務。"
---

如果你想把「明天下午三點和張總開會 #工作」這類標題快速整理成任務資訊，可以直接把完整句子輸入標題欄；GranoFlow 會嘗試從標題裡識別時間、標籤、專案 / 里程碑提及和提醒，並顯示成建議，等你確認後才會套用到任務。
...
- **標籤**：#工作 #個人 這類井號標籤
- **專案 / 里程碑提及**：透過 `@` 或「加入專案」入口，可選擇既有專案下的可用里程碑；快速添加任務時，不會只把任務掛到專案本身
