---
title: "備份與復原"
description: "使用備份降低誤刪、設備損壞或遷移時的風險，並理解復原不會替代日常同步。"
...
使用備份降低誤刪、設備損壞或遷移時的風險，並理解復原不會替代日常同步。
...
![備份與復原 介面截圖](../../../screenshots/manual/zh-tw/data-backup-restore-management.png)
