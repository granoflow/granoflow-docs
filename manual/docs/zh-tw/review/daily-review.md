...
如果你想重新梳理當天任務時間，可以點「回顧今日任務」，讓 AI 幫你依照任務順序檢查每個任務用了多久，並整理當天涉及的領域、專案和里程碑推進。AI 只會產生建議；你把結果複製回 GranoFlow 後，仍需要在確認框確認，才會寫入任務開始時間、結束時間、標題、任務回顧或當天領域日報。完整流程見[回顧今日任務](../ai-assistance/daily-task-review)。
