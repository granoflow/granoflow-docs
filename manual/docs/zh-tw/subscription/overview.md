...
打開 GranoFlow 設定，進入帳號／訂閱頁面，就可以查看目前訂閱狀態。未訂閱且商店可用時，頁面會先顯示方案切換器和目前方案詳情；選擇天使會員或升級方案時，詳情卡會直接顯示 2026 年 11 月 22 日截止購買或截止付費升級為天使會員。商店暫不可用或正在載入時，頁面只顯示狀態說明、已包含權益、恢復購買和管理訂閱入口，不會顯示價格或購買按鈕。
